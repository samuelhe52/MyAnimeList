...
extension SchemaV1 {
    ...
    public final class AnimeEntry {
        ...
        public init(name: String, overview: String? = nil, onAirDate: Date? = nil, entryType: MediaTypeMetadata, linkToDetails: URL? = nil, posterURL: URL? = nil, backdropURL: URL? = nil, id: Int, dateSaved: Date? = nil, dateStarted: Date? = nil, dateFinished: Date? = nil) {
            self.name = name
